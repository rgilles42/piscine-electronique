...
int main(void) {
	...
	while (1) {
		inst = ADC; 
		disp_set(disp_d1, compose_segments(inst % 10000 / 1000, 0));
		disp_set(disp_d2, compose_segments(inst % 1000 / 100, 0));
		disp_set(disp_d3, compose_segments(inst % 100 / 10, 0));
		disp_set(disp_d4, compose_segments(inst % 10, 0));
	}
}